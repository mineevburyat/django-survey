...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_response', 'interviewer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='interviewer', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Response.interviewee'
        db.add_column(u'survey_response', 'interviewee',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='interviewee', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.interviewer'
        db.delete_column(u'survey_response', 'interviewer_id')

        # Deleting field 'Response.interviewee'
        db.delete_column(u'survey_response', 'interviewee_id')
    ...
    models = {
        ...
        u'survey.response': {
            ...
            'interviewee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'interviewee'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'interviewer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'interviewer'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'survey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Survey']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'survey.survey': {
